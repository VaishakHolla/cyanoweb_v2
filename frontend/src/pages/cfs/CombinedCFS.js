...
const CombinedCFS = () => {
  ...
  const defaultValues = {
    ...
    coagulantType: "",
    coagulantManufacturer: "", //inputText
    coagulantChemicalDosage: null, //inputNumber
    coagulantMixingSpeed: null, //inputNumber
    coagulantReactionTime: null, //
    coagulantReactionUnit: "", //dropdown [Min,Sec]

    flocculantType: "",
    flocculantManufacturer: "", //inputText
    flocculantChemicalDosage: null, //inputNumber
    flocculantMixingSpeed: null, //inputNumber
    flocculantReactionTime: null, //
    flocculantReactionUnit: "", //dropdown [Min,Sec]

    sedimentationReactionTime: null, //
    sedimentationReactionUnit: "", //dropdown [Min,Sec]
  ...
  useEffect(() => {
    ...
    const interval = setTimeout(() => {
      if (
        ...
        setValue(
          "turbidityRemoval",
          ((watchTurbidity[1] - watchTurbidity[0]) / watchTurbidity[1]) * 100
        );
      }
      if (
  ...
  const onSubmit = async (data, e) => {
    ...
    const rawResponse = await fetch(url, {
      ...
      body: JSON.stringify({
        ...
        coagulant_type: data.coagulantType.name, //dropdown
        
        coagulant_manufacturer: data.coagulantManufacturer, //inputText
      ...
      <>
        ...
        <div className="align-form-inputs">
          <Controller
            name="coagulantType"
            control={control}
            rules={{ required: "coagulant type is required." }}
            render={({ field, fieldState }) => (
              <div className=" align-items-center" style={{ margin: "20px" }}>
                <span className="p-float-label" style={{ margin: "5px" }}>
        ...
        <div className="align-form-inputs">
          <Controller
            name="flocculantType"
            control={control}
            rules={{ required: "flocculant type is required." }}
            render={({ field, fieldState }) => (
              <div className=" align-items-center" style={{ margin: "20px" }}>
                <span className="p-float-label" style={{ margin: "5px" }}>
                <span className="requiredInput">*</span><Dropdown
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          >
            <div
              className="col-3"
              style={{
                backgroundColor: "rgb(140,163,140)",
                margin: "1.75em",
                borderRadius: ".5em",
              }}
            >
