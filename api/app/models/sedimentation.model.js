module.exports = (mongoose) => {
    const SedimentationSchema = mongoose.Schema(
      {
        basic_information: {
    ...
    SedimentationSchema.method("toJSON", function() {
        const { __v, _id, ...object } = this.toObject();
        object.id = _id;
        return object;
      });
  
    const Sedimentation = mongoose.model("sedimentation", SedimentationSchema);
